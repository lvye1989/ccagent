  ...
  if (message.startsWith("Commands:")) {
    return {
      ...
      body: [
        ...
        "/mcp — Select each MCP Open/Close; /mcp auth <name> for browser authorization",
        ...
        "/agents — Select each Agent Open/Close; /agents list shows all states",
        ...
        "/agent-skill [open|close] — Open or close Skills",
